...
import { TouchableOpacity, StyleSheet, Text, ScrollView, View, Image } from 'react-native';
...
const handleLogin = () => {
  ...
  if (user) {
    navigation.navigate('Página Inicial | Tech One Two'); // Navegue para a tela de Cadastro
...
return(
  ...
  <TextInput
    style={[styles.input, { flex: 0.5, borderRadius: 10, boxShadow: '2px 2px 5px rgba(0, 0, 0, 0.3)',}]} // Ajuste o valor flex para aumentar a largura do campo
    placeholder="Usuário"
    value={username}
  ...
  <TouchableOpacity
    style={[styles.button, styles.buttonShadow, { backgroundColor: 'black' }]}
    onPress={handleLogin}
  >
